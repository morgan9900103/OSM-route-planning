...
```
git clone https://github.com/morgan9900103/OSM-route-planning.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:udacity/OSM-route-planning.git --recurse-submodules
```
